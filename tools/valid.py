...
def get_file_name_by_id(image_id):
    ...
    """
    annotations_path = "E:\\coco\\annotations\\person_keypoints_val2017.json"
    ...
    # print(file_name)
    if file_name:
            return file_name.split("\\")[-1].replace(".jpg", "")
    return None
...
def main():
    ...
    for i, (images, annos) in enumerate(data_loader):
        ...
        newoutpurdir=os.path.join(final_output_dir,'paper_result')
